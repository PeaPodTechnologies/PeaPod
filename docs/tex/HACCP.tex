...
\begin{table}[!ht]
    ...
    \hline \multicolumn{2}{|l|}
        ...
        {\textbf{Evaluation}}}
        & \textit{Severity}         & Introduces unnecessary organic material into growth areas, raises prevelance of other organisms, absorbs nutrients and emits waste products. \\ \cline{2-3} \multicolumn{1}{|l|}{}
        & \textit{Likelihood}       & Given damp conditions and a plant-optimized light source, algae growth is likely. Can be reduced by ensuring GPs are followed when harvesting crops such that no organic material is left behind. \\ \cline{2-3} \multicolumn{1}{|l|}{}
