...
% ===== PROMPT =====
PeaPod automates data collection and nutrient transfer, meaning its operational costs are near-zero. After initial assembly, crews need only check for notifications to harvest and fill resources. Aeroponic harvesting is simple, since the plant is just removed from its cup. Since nutrient balance is maintained automatically, resource refilling is simply filling nutrient syringes and the water tank to max capacity. This results in mere minutes of work per week.
%4 hrs/week
