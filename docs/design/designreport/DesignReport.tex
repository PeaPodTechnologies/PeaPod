...
% Range of environments, can grow any plant
...
% Maybe?
% PeaPod aims to be the iPhone of automated growing---yes, the camera, notepad, cell phone, and MP3 player already existed, but it had never been put together quite so well.

% Small = better control from faster response
...
% Can be placed anywhere, not purpose-built
...
% Efficiency, recycling, parameter independence
...
% Open source, parts availability
