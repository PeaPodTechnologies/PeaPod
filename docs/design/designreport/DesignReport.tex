...
PeaPod’s modularity and ease of storage can turn unused city spaces to PeaPod "farms". With more fresh produce in local areas, PeaPod can be used as a direct food delivery system to paying customers. Through a subscription service, patrons would get fresh produce without a middle man. By eliminating long-distance transport, distribution, or grocery stores, PeaPod opens the possibility for fresher, more nutritious produce for the general public at a lower cost.

\textbf{Crowd-Sourced Research}

PeaPod's automation makes it unique in the research space, allowing for autonomous, off-site research in a method similar to de-centralized protein folding.Universities can save costs related to space and energy usage by subsidizing PeaPods to individuals, schools, or even restaurants. Users receive sets of parameters to grow crops with, and the data is sent back to the institution. The user uses the produce at the cost of space and energy, while the institution provides parameters with which to grow. The result is a massive dataset, conducted in identical conditions in different places, verified by comparison with devices conducting the same tests.

This makes PeaPod an effective tool in climate change famine aid. By predicting likelihood of future conditions in at-risk areas (i.e. arctic climates, those at risk due to global warming), researchers can conduct tests ahead of time to determine what seeds, traits, and care parameters are most effective for certain conditions. This information can also inform the development of seeds more resistant to extreme climates, letting areas counteract food scarcity by having a variety of viable options prepared ahead of time.

\textbf{De-centralized Production} %ClosedComment I like this one, should add more though - NV

Many crops are only feasible in certain climates, making global transport necessary to sell to foreign markets. This reduces freshness, necessitates preservatives, and increases the carbon footprint of agriculture. By upscaling PeaPod technology to a farm scale, climate-bound crops can be produced in any location. This creates region-based farms that produce a variety of crops, reducing transport needs and making it easier to have a local food diet.

Additionally, PeaPod's form factor makes it a viable tool for at-home production, either in cities or off-grid living away from population centres. With only a solar power source, access to water, and a compact supply of nutrient solutions, users can sustain a variety of time-intensive crops even through winter months without travelling for nutrients and supplies.
...
For many in developing countries, finding fresh produce is a struggle whilst growing your own is prohibitively expensive \cite{foodsecurity}. Micro-loan platforms have attempted to solve this by letting donors fund an interest-free loan to these individuals, who invest in technology or infrastructure which then pays the loan as a percentage of its surplus. 

Unfortunately, agricultural micro-loans are only feasible for individuals in rural areas with arable land and climate. PeaPod's small, adaptable scale and minimal input make it easy for urban non-farmers to produce food in small spaces with minimal effort.

PeaPod brings this solution to low-income urban areas by creating a platform for donors to micro-loan PeaPod units and inputs to those in need. The user will feed themselves and sell surplus produce, while a percentage of sales goes to pay off the interest-free loan for the unit. Once paid off, PeaPod continues to produce food, and surplus sales fund the continued operation of the unit. 

This creates permanent, self-sustaining automated agricultural infrastructure that pays for itself as it grows, requiring little initial capital to get started. Over time, this creates entire farms throughout high density buildings, generating yield with little lost space and almost no labour. In this manner, entire communities can become completely self-sufficient.

\uline{\textbf{3893 Characters} (893 over)}
