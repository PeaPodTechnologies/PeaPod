...
Hydroponic and aeroponic crops have seen commercial success, suggesting that their output is of sufficient hedonic quality to be desired \cite{commercialhydro}. Additionally, PeaPod is designed to optimize for edible plant mass, nutrient density, and other health indicators, pushing Hedonic ratings up over time.
