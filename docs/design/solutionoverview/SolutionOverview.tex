...
\begin{itemize} 
    ...
    \item Nutrient (\ref{sec:nutrients}) and pH-adjustment (\ref{sec:ph}) solutions are mixed in-line at an adjustable ratio (\ref{sec:automation}); \footnote{I.e. add X mL of nutrient solution Y per mL water to achieve Z ppm, or add A mL of pH down solution per mL water to achieve a pH of B.}
