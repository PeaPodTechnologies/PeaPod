...
\textbf{Purpose}: Actively increases growth environment air humidity on command.
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textit{Evaporator Oven}: \textbf{Onboard systems} provide an oven that can maintain 200°C for 60 minutes. Heats cartridge to evaporate/"bake off" moisture collected by silica beads, thus "recharging" them.
\end{itemize}
