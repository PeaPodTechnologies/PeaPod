...
\begin{titlepage}
    \begin{center}
        ...
        \textbf{\large{The Eden Initiative - Design Brief}}
        ...
        Jayden Lefebvre - Principal Design Engineer\\\small{jayden.lefebvre@mail.utoronto.ca}

        \vspace{0.5cm}

        \normalsize{Luke Kowalski - CEO}\\\small{luke@projectgap.ca}\\
...
to the NASA/CSA Deep Space Food Challenge Phase 1 \cite{dsfc}.
...
\begin{center}
    \begin{tabular}{| @{\makebox[2em][l]{\rownumber}} | l | l |} 
        \hline
        \multicolumn{1}{| @{\makebox[2em][l]{\#}} | l |}{\textbf{Metric}} & \textbf{Units}\\ 
        \hline
...
\begin{center}
    \begin{tabular}{| @{\makebox[2em][l]{\rownumber}} | l | l |} 
        ...
        \hline
        Required Human Intervention Time - Maintenance \hfill (LL16) & min/day \\
        \hline
        Required Human Intervention Time - Setup \hfill (LL16) & min \\
        \hline
...
\begin{center}
    \begin{tabular}{| @{\makebox[2em][l]{\rownumber}} | p{11.5cm} | p{3.5cm} |} 
        \hline
        \multicolumn{1}{| @{\makebox[2em][l]{\#}} | l |}{\textbf{Metric}} & \textbf{Units}\\ 
        \hline
        ...
        Cost \hfill (LL37) & CAD \\
        \hline
        Outer Dimensions \hfill (LL38) & m (x,y,z) \\
        \hline
...
\begin{center}
    \begin{tabular}{|l|l|}
        ...
        M4 & a \\
        \hline
        M75 & $\le$ 2 m${}^3$ \cite{applicantguide} \\
        \hline
        M76 & $\le$ 2 m${}^3$ \cite{applicantguide} \\
        \hline
    \end{tabular}
\end{center}
